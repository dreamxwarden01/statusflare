...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header h1 { font-size: 2.5rem; color: var(--text-heading); margin-bottom: 0.5rem; }
        ...
        .general-availability h2 { font-size: 1.25rem; color: var(--text-heading); font-weight: 600; }
        ...
        /* Dark theme backgrounds for incident updates */
        @media (prefers-color-scheme: dark) {
            .incident-update.initial-update { 
